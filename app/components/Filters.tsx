...
interface FiltersProps {
    categories?: string[]
    onApply?: (filters: { category: string; country: string }) => void
    onClear?: () => void
...
export default function Filters({
    categories = ['Work Life', 'Customer Service', 'Student Life'],
    onApply,
    onClear,
    initialCategory = '',
    ...
    const handleApply = () => {
        onApply?.({ category: selectedCategory, country: selectedCountry })
    }
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md p-5">
            ...
            <div className="flex gap-2 mt-3">
                <button
                    onClick={handleApply}
                    className="bg-orange-500 text-white text-sm px-4 py-2 rounded-md hover:bg-orange-600 transition flex-1"
                >
                    Apply
                </button>
                <button
                    onClick={handleClear}
                    className="bg-gray-100 text-gray-700 text-sm px-4 py-2 rounded-md hover:bg-gray-200 transition flex-1"
                >
                    Clear
                </button>
            </div>
